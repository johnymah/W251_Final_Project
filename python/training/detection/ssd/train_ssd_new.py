...
def train(loader, net, criterion, optimizer, device, debug_steps=100, epoch=-1):
    ...
    for i, data in enumerate(loader):
        ...
        writer.add_scalar('Train Avg Loss', running_loss, epoch)
        writer.add_scalar('Train Avg Regression Loss', running_regression_loss, epoch)
        writer.add_scalar('Train Avg Classification Loss', running_classification_loss, epoch)
...
def test(loader, net, criterion, device):
    ...
    for _, data in enumerate(loader):
        ...
        writer.add_scalar('Test Avg Loss', running_loss, epoch)
        writer.add_scalar('Test Avg Regression Loss', running_regression_loss, epoch)
        writer.add_scalar('Test Avg Classification Loss', running_classification_loss, epoch)
